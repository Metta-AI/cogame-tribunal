"""Run matched native Tribunal episodes with retained SystemOne call traces."""
                                    ...
                                    json.dumps(
                                        {
                                            ...
                                            "version": 1,
                                            "trace_id": trace_id,
                                            "trajectory_id": f"tribunal-{seed}",
                                            "workload": "tribunal",
                                            "schema_revision": "tribunal.player.v2-external-action",
