...
# Substitute: tribunal, coworld-tribunal, 5.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-tribunal:ci)
#   SMOKE_SLUG                 game slug                        (tribunal)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/tribunal)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/tribunal-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-tribunal:ci}}"
slug="${SMOKE_SLUG:-tribunal}"
